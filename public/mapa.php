...
<head>
    ...
    <script defer src="https://maps.googleapis.com/maps/api/js?libraries=places&language=pt-br&key=AIzaSyA6qDPshk3c3RuR3soH8pk6fF5vo4MQiSY">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <form id="distance_form">
                    ...
                    <input class="btn btn-primary" type="submit" value="botao" />
